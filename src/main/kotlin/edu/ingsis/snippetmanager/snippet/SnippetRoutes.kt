...
@RestController
class SnippetRoutes @Autowired constructor(private val service: SnippetService): SnippetRoutesSpec {
    override fun getAllSnippets(): List<Snippet> {
        return service.getAllSnippets()
    }

    override fun getSnippet(@PathVariable id: Long): Snippet {
        return service.getSnippet(id)
    }

    override fun createSnippet(@RequestBody snippet: SnippetDto): Snippet {
        return service.createSnippet(snippet.title, snippet.description, snippet.content)
    }

    override fun deleteSnippet(@PathVariable id: Long) {
